        ...
        try {
            ...
            switch (message.type) {
                ...
                case "Bid":
                    ...
                    BidLists.addBid(bid);
                    Item i = BidLists.items[message.itemNum-1];
                    String bids = BidLists.toString(i);
                    Message msg = new Message("bidPlaced",bids,message.bidAmount );
                    toClient.println(gson.toJson(msg));
                    toClient.flush();
                case "strip":
